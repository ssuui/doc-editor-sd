...
> 因为组件默认使用 `Curl`，所以我们需要修改对应的 `GuzzleClient` 为协程客户端，或者修改常量 [SWOOLE_HOOK_FLAGS](/coroutine?id=swoole-runtime-hook-level)
...
参考 [SWOOLE_HOOK_FLAGS](/coroutine?id=swoole-runtime-hook-level)
