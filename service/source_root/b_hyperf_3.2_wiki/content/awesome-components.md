...
如果您开发的协程组件适配了 Hyperf，那么您可以直接对 [hyperf/hyperf](https://github.com/hyperf/hyperf) 项目的 `master` 分支发起您的 `Pull Request`，也就是更改当前页`(awesome-components)`。

## 如何适配 Hyperf ?

我们为您提供了一份 [Hyperf 组件开发指南](/component-guide/intro)，以帮助您开发 Hyperf 组件或适配 Hyperf 框架。
...
- [hyperf/watcher](/watcher) 官方热更新组件
...
- [w7corp/wechat](/sdks/wechat) EasyWeChat，一个流行的非官方微信 SDK
